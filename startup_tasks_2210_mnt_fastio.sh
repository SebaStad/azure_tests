...
cd $BASEDIR
sudo chmod -R 777 .
wget https://gitlab.palm-model.org/releases/palm_model_system/-/archive/v22.10/palm_model_system-v22.10.tar.gz && tar -xf palm_model_system-v22.10.tar.gz
...
cd $BASEDIR/palm_model_system-v22.10
sudo chmod -R 777 .
bash install -p ../palm
...
cp ../palm_model_system-v22.10/packages/palm/model/tests/cases/example_cbl/INPUT/example_cbl_p3d JOBS/example_cbl/INPUT/
