...
az storage account create --resource-group $batch_rg --name $storage_account_name --location $region --sku Standard_LRS --encryption-services blob
...
az storage container create --name batch --account-name $storage_account_name --account-key $storage_key
